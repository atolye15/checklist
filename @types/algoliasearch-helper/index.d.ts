...
import { SearchClient as Client } from 'algoliasearch';
...
declare namespace algoliasearchHelper {
  ...
  export class AlgoliaSearchHelper extends EventEmitter {
    ...
    on(
      event: 'change' | 'search',
      cb: (state: SearchParameters, lastResults: SearchResults | null) => any,
    ): this;
    on(
      event: 'searchForFacetValues',
      cb: (state: SearchParameters, facet: string, query: string) => any,
    ): this;
  ...
  export class SearchParameters implements QueryParameters {
    ...
    clearRefinements(
      attribute?: string | ((value: any, attribute: string, type: string) => any),
    ): SearchParameters;
