...
const About: FC = () => (
  <Layout>
    <div className="row u-justify-content-center u-padding-top-xlarge u-padding-bottom-2xlarge u-text-style-subtitle">
    ...
    <div className="u-padding-ends-2xlarge">
      ...
      <div className="row u-padding-bottom-large">
        <div className="col col--lg-6">
          <Blockquote className="u-text-style-large-body">
