...
export type ChecklistFragment = Pick<MarkdownRemark, 'excerpt'> & {
  frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'category' | 'tags'>>;
  fields: Maybe<Pick<MarkdownRemarkFields, 'slug' | 'categorySlug' | 'todoCount'>>;
};
...
export type CategoriesQuery = {
  categories: { group: Array<Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'>> };
};
...
export type CategoryDetailQuery = {
  checklists: Pick<MarkdownRemarkConnection, 'totalCount'> & {
...
export type ChecklistDetailQuery = {
  markdownRemark: Maybe<
    Pick<MarkdownRemark, 'html'> & {
      frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'tags' | 'category'>>;
      fields: Maybe<Pick<MarkdownRemarkFields, 'todoCount'>>;
    }
  >;
};
...
export type HomePageQueryQuery = {
  checklists: Pick<MarkdownRemarkConnection, 'totalCount'> & { nodes: Array<ChecklistFragment> };
};
